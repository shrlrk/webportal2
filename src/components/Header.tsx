              ...
              <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-lg py-2 z-50">
                {!currentUser ? (
                  ...
                  <>
                    ...
                    <button onClick={handleAuthAction} className="w-full text-left px-4 py-2.5 text-sm text-blue-500 hover:bg-blue-50 transition-colors font-medium">로그아웃</button>
                  </>
                )}
              </div>
            )}
